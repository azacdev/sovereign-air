  ...
  const plansList = [
    {
      ...
      price: "270",
      description:
        "Indulge in the epitome of luxury travel with our Private Charter Jet. Experience exclusive comfort, personalized service, and seamless journeys tailored to your desires.",
    },
    {
      ...
      price: "270",
      description:
        "Ensuring your well-being is our priority. Our Medical Chopper provides swift and secure transportation for medical emergencies, combining speed and safety with compassionate care.",
    },
    {
      title: "Private Plane",
      image: plan3,
      ...
      price: "270",
      description:
        "Embark on a voyage of sophistication and style aboard our Private Plane. Revel in the freedom to travel with unmatched elegance, where every moment is a testament to luxury.",
    },
  ];

  return (
    <div
      className="flex w-full pt-5 pb-20 md:px-20 px-8 flex-col gap-16 justify-center items-center"
      id="plans"
    >
      <div className="flex flex-col w-full items-center">
        ...
        <p className="max-w-[400px] text-center mt-4">
          Explore our meticulously crafted plans designed to elevate your travel
